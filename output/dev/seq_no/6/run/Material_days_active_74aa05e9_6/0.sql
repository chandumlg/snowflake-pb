   ...
   CREATE OR REPLACE VIEW "DAYS_ACTIVE___MATERIAL_RSTRACKS_2A8B6134_6" AS (
...
WHERE
   ...
   CREATE OR REPLACE VIEW "MATERIAL_DAYS_ACTIVE_74AA05E9_6_INTERNAL_TRANSIENT_EV_VIEW" AS (
    ...
    SELECT
        ...
        Material_rsTracks_var_table_e3351b8c_6.user_main_id
...
,
    ...
    FROM CHANDU2.MATERIAL_USER_VAR_TABLE_9F95E1BE_6
        ...
        RIGHT JOIN CHANDU2.MATERIAL_RSTRACKS_VAR_TABLE_E3351B8C_6 USING
        (user_main_id)
