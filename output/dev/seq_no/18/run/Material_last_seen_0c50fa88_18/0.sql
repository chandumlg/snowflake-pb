   ...
   CREATE OR REPLACE VIEW "LAST_SEEN___MATERIAL_RSTRACKS_2A8B6134_18" AS (
...
WHERE
   ...
   CREATE OR REPLACE VIEW "MATERIAL_LAST_SEEN_0C50FA88_18_INTERNAL_TRANSIENT_EV_VIEW" AS (
