   ...
   DROP VIEW IF EXISTS "RUDDERSTACK_NOOP_VIEW";  
            ...
            BEGIN
                ...
                IF (PRECISION_VAL IS NULL OR SCALE_VAL IS NULL) THEN
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_RSTRACKS_VAR_TABLE_E3351B8C_4 ADD COLUMN USER_MAIN_ID_959 ' || DATA_TYPE;
                ELSE
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_RSTRACKS_VAR_TABLE_E3351B8C_4 ADD COLUMN USER_MAIN_ID_959 ' || DATA_TYPE || '(' || PRECISION_VAL || ',' || SCALE_VAL || ')';
                END IF;
        ...
        SET USER_MAIN_ID_959 = MATERIAL_USER_MAIN_ID_5F04745A_4_INTERNAL_TRANSIENT_IV_VIEW.user_main_id
    ...
    ALTER TABLE "CHANDU2"."MATERIAL_RSTRACKS_VAR_TABLE_E3351B8C_4" RENAME COLUMN USER_MAIN_ID_959 TO user_main_id;
