   ...
   CREATE OR REPLACE VIEW "USER_MAIN_ID___MATERIAL_RSTRACKS_2A8B6134_4" AS (
...
WHERE
   ...
   CREATE OR REPLACE VIEW "MATERIAL_USER_MAIN_ID_5F04745A_4_INTERNAL_TRANSIENT_IV_VIEW" AS (
                ...
                FROM CHANDU2.MATERIAL_RSTRACKS_VAR_TABLE_E3351B8C_4 
                
                LEFT JOIN CHANDU2.MATERIAL_USER_DEFAULT_ID_STITCHER_1551CC21_4 AS TempIdsAlias_user_1
