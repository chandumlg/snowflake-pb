   ...
   DROP VIEW IF EXISTS "RUDDERSTACK_NOOP_VIEW";  
            ...
            BEGIN
                ...
                IF (PRECISION_VAL IS NULL OR SCALE_VAL IS NULL) THEN
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_9F95E1BE_6 ADD COLUMN DAYS_ACTIVE_375 ' || DATA_TYPE;
                ELSE
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_9F95E1BE_6 ADD COLUMN DAYS_ACTIVE_375 ' || DATA_TYPE || '(' || PRECISION_VAL || ',' || SCALE_VAL || ')';
                END IF;
        ...
        SET DAYS_ACTIVE_375 = MATERIAL_DAYS_ACTIVE_74AA05E9_6_INTERNAL_TRANSIENT_EV_VIEW.days_active
    ...
    ALTER TABLE "CHANDU2"."MATERIAL_USER_VAR_TABLE_9F95E1BE_6" RENAME COLUMN DAYS_ACTIVE_375 TO days_active;
