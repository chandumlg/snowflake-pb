   ...
   CREATE OR REPLACE VIEW "FIRST_SEEN___MATERIAL_RSTRACKS_2A8B6134_18" AS (
...
WHERE
   ...
   CREATE OR REPLACE VIEW "MATERIAL_FIRST_SEEN_15934164_18_INTERNAL_TRANSIENT_EV_VIEW" AS (
