   ...
   DROP VIEW IF EXISTS "RUDDERSTACK_NOOP_VIEW";  
            ...
            BEGIN
                ...
                IF (PRECISION_VAL IS NULL OR SCALE_VAL IS NULL) THEN
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_F8AD61B7_16 ADD COLUMN ID_TYPE_EMAIL_COUNT_804 ' || DATA_TYPE;
                ELSE
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_F8AD61B7_16 ADD COLUMN ID_TYPE_EMAIL_COUNT_804 ' || DATA_TYPE || '(' || PRECISION_VAL || ',' || SCALE_VAL || ')';
                END IF;
        ...
        SET ID_TYPE_EMAIL_COUNT_804 = MATERIAL_ID_TYPE_EMAIL_COUNT_62739FED_16_INTERNAL_TRANSIENT_EV_VIEW.id_type_email_count
    ...
    ALTER TABLE "CHANDU2"."MATERIAL_USER_VAR_TABLE_F8AD61B7_16" RENAME COLUMN ID_TYPE_EMAIL_COUNT_804 TO id_type_email_count;
