   ...
   CREATE OR REPLACE VIEW "DAYS_ACTIVE___MATERIAL_RSTRACKS_2A8B6134_7" AS (
...
WHERE
   ...
   CREATE OR REPLACE VIEW "MATERIAL_DAYS_ACTIVE_74AA05E9_7_INTERNAL_TRANSIENT_EV_VIEW" AS (
