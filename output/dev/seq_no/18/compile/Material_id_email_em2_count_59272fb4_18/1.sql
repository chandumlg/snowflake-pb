   ...
   DROP VIEW IF EXISTS "RUDDERSTACK_NOOP_VIEW";  
            ...
            BEGIN
                ...
                IF (PRECISION_VAL IS NULL OR SCALE_VAL IS NULL) THEN
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_F8AD61B7_18 ADD COLUMN ID_EMAIL_EM2_COUNT_50 ' || DATA_TYPE;
                ELSE
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_F8AD61B7_18 ADD COLUMN ID_EMAIL_EM2_COUNT_50 ' || DATA_TYPE || '(' || PRECISION_VAL || ',' || SCALE_VAL || ')';
                END IF;
        ...
        SET ID_EMAIL_EM2_COUNT_50 = MATERIAL_ID_EMAIL_EM2_COUNT_59272FB4_18_INTERNAL_TRANSIENT_EV_VIEW.id_email_em2_count
    ...
    ALTER TABLE "CHANDU2"."MATERIAL_USER_VAR_TABLE_F8AD61B7_18" RENAME COLUMN ID_EMAIL_EM2_COUNT_50 TO id_email_em2_count;
