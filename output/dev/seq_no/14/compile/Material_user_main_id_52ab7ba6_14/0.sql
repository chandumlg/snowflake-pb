   ...
   CREATE OR REPLACE VIEW "USER_MAIN_ID___MATERIAL_RSTRACKS_2A8B6134_14" AS (
...
WHERE
   ...
   CREATE OR REPLACE VIEW "MATERIAL_USER_MAIN_ID_52AB7BA6_14_INTERNAL_TRANSIENT_IV_VIEW" AS (
                ...
                FROM CHANDU2.MATERIAL_RSTRACKS_VAR_TABLE_E3351B8C_14 
                
                LEFT JOIN CHANDU2.MATERIAL_USER_ID_STITCHER_ED62A9A5_14 AS TempIdsAlias_user_1
