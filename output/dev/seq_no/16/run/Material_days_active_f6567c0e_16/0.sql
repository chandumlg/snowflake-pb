   ...
   CREATE OR REPLACE VIEW "DAYS_ACTIVE___MATERIAL_RSTRACKS_2A8B6134_16" AS (
...
WHERE
   ...
   CREATE OR REPLACE VIEW "MATERIAL_DAYS_ACTIVE_F6567C0E_16_INTERNAL_TRANSIENT_EV_VIEW" AS (
