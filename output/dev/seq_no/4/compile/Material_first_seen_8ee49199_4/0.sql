   ...
   CREATE OR REPLACE VIEW "FIRST_SEEN___MATERIAL_RSTRACKS_2A8B6134_4" AS (
...
WHERE
   ...
   CREATE OR REPLACE VIEW "MATERIAL_FIRST_SEEN_8EE49199_4_INTERNAL_TRANSIENT_EV_VIEW" AS (
