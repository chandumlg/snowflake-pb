   ...
   CREATE OR REPLACE VIEW "LAST_SEEN___MATERIAL_RSTRACKS_2A8B6134_16" AS (
...
WHERE
   ...
   CREATE OR REPLACE VIEW "MATERIAL_LAST_SEEN_0C50FA88_16_INTERNAL_TRANSIENT_EV_VIEW" AS (
