   ...
   CREATE OR REPLACE VIEW "DAYS_ACTIVE___MATERIAL_RSTRACKS_2A8B6134_18" AS (
...
WHERE
   ...
   CREATE OR REPLACE VIEW "MATERIAL_DAYS_ACTIVE_F6567C0E_18_INTERNAL_TRANSIENT_EV_VIEW" AS (
    ...
    SELECT
        ...
        Material_rsTracks_var_table_e3351b8c_18.user_main_id
...
,
    ...
    FROM CHANDU2.MATERIAL_USER_VAR_TABLE_F8AD61B7_18
        ...
        RIGHT JOIN CHANDU2.MATERIAL_RSTRACKS_VAR_TABLE_E3351B8C_18 USING
        (user_main_id)
