   ...
   DROP VIEW IF EXISTS "RUDDERSTACK_NOOP_VIEW";  
            ...
            BEGIN
                ...
                IF (PRECISION_VAL IS NULL OR SCALE_VAL IS NULL) THEN
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_9F95E1BE_6 ADD COLUMN USER_LIFESPAN_894 ' || DATA_TYPE;
                ELSE
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_9F95E1BE_6 ADD COLUMN USER_LIFESPAN_894 ' || DATA_TYPE || '(' || PRECISION_VAL || ',' || SCALE_VAL || ')';
                END IF;
        ...
        SET USER_LIFESPAN_894 = MATERIAL_USER_LIFESPAN_5B965BEF_6_INTERNAL_TRANSIENT_EV_VIEW.user_lifespan
    ...
    ALTER TABLE "CHANDU2"."MATERIAL_USER_VAR_TABLE_9F95E1BE_6" RENAME COLUMN USER_LIFESPAN_894 TO user_lifespan;
