   ...
   DROP VIEW IF EXISTS "RUDDERSTACK_NOOP_VIEW";  
            ...
            BEGIN
                ...
                IF (PRECISION_VAL IS NULL OR SCALE_VAL IS NULL) THEN
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_F8AD61B7_12 ADD COLUMN LAST_SEEN_592 ' || DATA_TYPE;
                ELSE
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_F8AD61B7_12 ADD COLUMN LAST_SEEN_592 ' || DATA_TYPE || '(' || PRECISION_VAL || ',' || SCALE_VAL || ')';
                END IF;
        ...
        SET LAST_SEEN_592 = MATERIAL_LAST_SEEN_0C50FA88_12_INTERNAL_TRANSIENT_EV_VIEW.last_seen
    ...
    ALTER TABLE "CHANDU2"."MATERIAL_USER_VAR_TABLE_F8AD61B7_12" RENAME COLUMN LAST_SEEN_592 TO last_seen;
