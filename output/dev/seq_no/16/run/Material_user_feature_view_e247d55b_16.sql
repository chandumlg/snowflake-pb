   ...
   CREATE OR REPLACE VIEW "MATERIAL_USER_FEATURE_VIEW_E247D55B_16" AS (
...
/* endMacros */
    ...
    , distinct_served_ids AS (
        ...
        , user_all_var_table_CTE AS (
            SELECT DISTINCT Material_user_var_table_f8ad61b7_16.user_main_id as user_main_id
            
                
                     , MATERIAL_USER_VAR_TABLE_F8AD61B7_16.DAYS_ACTIVE 
            
                
                     , MATERIAL_USER_VAR_TABLE_F8AD61B7_16.ID_TYPE_EMAIL_COUNT 
            
                
                     , MATERIAL_USER_VAR_TABLE_F8AD61B7_16.USER_LIFESPAN 
