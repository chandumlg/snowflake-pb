   ...
   DROP VIEW IF EXISTS "RUDDERSTACK_NOOP_VIEW";  
            ...
            BEGIN
                ...
                IF (PRECISION_VAL IS NULL OR SCALE_VAL IS NULL) THEN
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_F8AD61B7_16 ADD COLUMN FIRST_SEEN_11 ' || DATA_TYPE;
                ELSE
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_F8AD61B7_16 ADD COLUMN FIRST_SEEN_11 ' || DATA_TYPE || '(' || PRECISION_VAL || ',' || SCALE_VAL || ')';
                END IF;
        ...
        SET FIRST_SEEN_11 = MATERIAL_FIRST_SEEN_15934164_16_INTERNAL_TRANSIENT_EV_VIEW.first_seen
    ...
    ALTER TABLE "CHANDU2"."MATERIAL_USER_VAR_TABLE_F8AD61B7_16" RENAME COLUMN FIRST_SEEN_11 TO first_seen;
