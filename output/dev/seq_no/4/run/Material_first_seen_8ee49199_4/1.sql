   ...
   DROP VIEW IF EXISTS "RUDDERSTACK_NOOP_VIEW";  
            ...
            BEGIN
                ...
                IF (PRECISION_VAL IS NULL OR SCALE_VAL IS NULL) THEN
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_9F95E1BE_4 ADD COLUMN FIRST_SEEN_167 ' || DATA_TYPE;
                ELSE
                    ALTER_STMT := 'ALTER TABLE CHANDU2.MATERIAL_USER_VAR_TABLE_9F95E1BE_4 ADD COLUMN FIRST_SEEN_167 ' || DATA_TYPE || '(' || PRECISION_VAL || ',' || SCALE_VAL || ')';
                END IF;
        ...
        SET FIRST_SEEN_167 = MATERIAL_FIRST_SEEN_8EE49199_4_INTERNAL_TRANSIENT_EV_VIEW.first_seen
    ...
    ALTER TABLE "CHANDU2"."MATERIAL_USER_VAR_TABLE_9F95E1BE_4" RENAME COLUMN FIRST_SEEN_167 TO first_seen;
