   ...
   CREATE OR REPLACE VIEW "DAYS_ACTIVE___MATERIAL_RSTRACKS_2A8B6134_9" AS (
...
WHERE
   ...
   CREATE OR REPLACE VIEW "MATERIAL_DAYS_ACTIVE_74AA05E9_9_INTERNAL_TRANSIENT_EV_VIEW" AS (
